...
class BasicPlace(nn.Module):
    ...
    def build_timing_op(self, params, placedb, timer=None):
        ...
        return timing.TimingOpt(
            ...
            getattr(placedb, 'timing_pin_names', placedb.pin_names),
            placedb.flat_net2pin_map,
            placedb.flat_net2pin_start_map,
            getattr(placedb, 'timing_net_name2id_map', placedb.net_name2id_map),
            getattr(placedb, 'timing_pin_name2id_map', placedb.pin_name2id_map),
