...
========================================================"""
    ...
    def design_name(self):
        ...
        """
        if getattr(self, '_physical_design_name', ''):
            return self._physical_design_name
        if self.aux_input: 
        ...
        elif getattr(self, 'def_path', ''):
            design_name = os.path.splitext(os.path.basename(self.def_path))[0]
        elif getattr(self, 'save_path', ''):
            design_name = os.path.basename(os.path.normpath(self.save_path))
        else:
            design_name = 'design'
        return design_name 
